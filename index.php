...
<head>
    <meta charset="utf-8" />
    <title>Guilherme de Carvalho Rodrigues</title>

    <!-- Meta Data -->
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <meta name="author" content="Guilherme de Carvalho Rodrigues" />
    <meta name="description" content="Portifólio de trabalhos realizados por Guilherme de Carvalho Rodrigues" />
    <!-- Styles -->
            ...
            <header class="header box">
                <div class="header__left">
                    ...
                    <div class="header__base-info">
                        <h4 class="title titl--h4">Guilherme de Carvalho Rodrigues</h4>
                        <div class="status">Desenvolvedor WEB</div>
                        <ul class="header__social">

                            <li>
                                <a href="https://github.com/guilhermecr00">
                                    <i class="font-icon icon-github"></i>
                                </a>
                            </li>

                            <li>
                                <a href="https://twitter.com/cadernodeumaus1">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                    <div class="box box-content">
                        ...
                        <div class="pb-0 pb-sm-2">
                            ...
                            <p>Olá, pessoal. Me chamo Guilherme e estou iniciando meus estudos em programação web.
